...
import {
  ...
  setLogLevel,
} from "https://cdn.jsdelivr.net/npm/livekit-client@2.5.3/dist/livekit-client.esm.min.js";
...
let currentUserName = "";
// 根据需要替换成自己的后端地址
const wsBase = "wss://api.yourdomin.top";
const httpBase = wsBase.startsWith("wss://")
  ? `https://${wsBase.slice(6)}`
  : wsBase.startsWith("ws://")
    ? `http://${wsBase.slice(5)}`
    : wsBase;
const LIVEKIT_TOKEN_ENDPOINT = `${httpBase}/sfu/token`;
